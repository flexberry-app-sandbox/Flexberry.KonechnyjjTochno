...
moduleForModel('i-i-s-konechnyjj-tochno-основ-показат', 'Unit | Serializer | i-i-s-konechnyjj-tochno-основ-показат', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-konechnyjj-tochno-основ-показат',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
